...
- **Date**: Captures seasonal timing effects that influence both coaching changes and performance.
- **Venue**: Home-field advantage influences match outcomes but is independent of coaching changes.
- **Team**: Controls for underlying club-specific factors (such as structure, budget, and talent) that affect both coaching decisions and match outcomes.
...
- **HomeTeam and AwayTeam**: Team identity is adjusted for via the Team variable.
...
See my [Final Presentation Slides](https://github.com/Alesandro-Rodriguez/is5150-ar/blob/milestone11/presentations/FinalPresentationSlides.html)
